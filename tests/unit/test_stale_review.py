...
def test_stale_autopilot_is_automated_regardless_of_source() -> None:
    # origin_source is no longer consulted: a "manual"-source autopilot stale
    # issue is still treated as automated (routing_blocker without a route).
    decision = classify_stale_in_review(
