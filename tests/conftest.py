...
def clean_settings(monkeypatch):
    ...
    for var in [
        ...
        "HEALTHCHECK_PORT",
        "DISCORD_REVIEW_CHANNEL_ID", "MULTICA_WEBHOOK_SECRET",
        "MULTICA_AUTOMATED_REVIEWERS", "MULTICA_REVIEW_ROUTING_MODE",
        "MULTICA_REVIEW_DRY_RUN", "MULTICA_REWORK_STATUS",
        "MULTICA_REVIEW_STATE_PATH",
